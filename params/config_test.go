...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllSochashProtocolChanges, new: AllSochashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllSochashProtocolChanges, new: AllSochashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllSochashProtocolChanges,
