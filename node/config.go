...
type Config struct {
    ...
    // HTTPTimeouts allows for customization of the timeout values used by
    // the HTTP RPC interface.
...
func (c *Config) NodeName() string {
	...
	if name == "gsoc" || name == "gsoc-testnet" {
		name = "Gsoc"
	}
	if c.UserIdent != "" {
		name += "/" + c.UserIdent
...
func (c *Config) ResolvePath(path string) string {
	...
	if c.name() == "gsoc" && isOldGethResource[path] {
		oldpath := ""
		if c.Name == "gsoc" {
