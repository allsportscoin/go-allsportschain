...
type Service struct {
	...
	eth    *soc.Ethereum      // Full Ethereum service if monitoring a full node
...
func New(url string, ethServ *soc.Ethereum, lesServ *les.LightEthereum) (*Service, error) {
...
func (s *Service) login(conn *websocket.Conn) error {
	...
	if info := infos.Protocols["eth"]; info != nil {
		...
		protocol = fmt.Sprintf("eth/%d", soc.ProtocolVersions[0])
	} else {
