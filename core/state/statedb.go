...
func (self *StateDB) getStateObject(addr common.Address) (stateObject *stateObject) {
	...
	var data Account
	log.Debug("getStateObject","enc",enc,"err",err,"addr",addr)
	if err := rlp.DecodeBytes(enc, &data); err != nil {
		log.Error("Failed to decode state object", "addr", addr, "err", err)
		return nil
	}
	log.Debug("getStateObject DecodeBytes","enc",enc,"err",err)
...
func (self *StateDB) Copy() *StateDB {
	...
	for addr := range self.journal.dirties {
		// As documented [here](https://github.com/allsportschain/go-allsportschain/pull/16485#issuecomment-380438527),
