...
func makeTestState() (Database, common.Hash, []*testAccount) {
	...
	db := NewDatabase(socdb.NewMemDatabase())
...
// account array.
func checkStateAccounts(t *testing.T, db socdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db socdb.Database, root common.Hash) error {
...
func checkStateConsistency(db socdb.Database, root common.Hash) error {
...
func TestEmptyStateSync(t *testing.T) {
	...
	if req := NewStateSync(empty, socdb.NewMemDatabase()).Missing(1); len(req) != 0 {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(socdb.Database), srcRoot)
