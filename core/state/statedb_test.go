...
func TestIntermediateLeaks(t *testing.T) {
	...
	transDb := socdb.NewMemDatabase()
	finalDb := socdb.NewMemDatabase()
...
// https://github.com/allsportschain/go-allsportschain/pull/15549.
func TestCopy(t *testing.T) {
	// Create a random state test to copy and modify "independently"
	orig, _ := New(common.Hash{}, NewDatabase(socdb.NewMemDatabase()))
...
func (test *snapshotTest) run() bool {
	...
	var (
		state, _     = New(common.Hash{}, NewDatabase(socdb.NewMemDatabase()))
...
// See https://github.com/allsportschain/go-allsportschain/pull/15225#issuecomment-380191512
func TestCopyOfCopy(t *testing.T) {
	sdb, _ := New(common.Hash{}, NewDatabase(socdb.NewMemDatabase()))
