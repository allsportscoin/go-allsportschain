...
func TestSetupGenesis(t *testing.T) {
	var (
		customghash = common.HexToHash("0xf5787c18c848d67a239e19844b8c9290d31a5a3dd333e0f212100e4ebf450bf8")
		customg     = Genesis{
	...
	tests := []struct {
		name       string
		fn         func(socdb.Database) (*params.ChainConfig, common.Hash, error)
	...
	}{
		{
			...
			fn: func(db socdb.Database) (*params.ChainConfig, common.Hash, error) {
				return SetupGenesisBlock(db, new(Genesis))
			},
			wantErr:    errGenesisNoConfig,
			wantConfig: params.AllSochashProtocolChanges,
		},
		{
		...
		},
		{
			...
			fn: func(db socdb.Database) (*params.ChainConfig, common.Hash, error) {
				...
				bc, _ := NewBlockChain(db, nil, oldcustomg.Config, sochash.NewFullFaker(), vm.Config{})
				defer bc.Stop()

				blocks, _ := GenerateChain(oldcustomg.Config, genesis, sochash.NewFaker(), db, 4, nil)
