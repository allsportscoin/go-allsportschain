...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db socdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db socdb.Database) error {
