...
func NewLesOdr(db socdb.Database, chtIndexer, bloomTrieIndexer, bloomIndexer *core.ChainIndexer, retriever *retrieveManager) *LesOdr {
	return &LesOdr{
		db:               db,
...
func (odr *LesOdr) Database() socdb.Database {
	return odr.db
}
