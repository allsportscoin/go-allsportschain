...
import (
	...
	"github.com/allsportschain/go-allsportschain/contracts/chequebook"
	"github.com/allsportschain/go-allsportschain/contracts/ens"
	...
	"github.com/allsportschain/go-allsportschain/p2p/protocols"
	"github.com/allsportschain/go-allsportschain/params"
	"github.com/allsportschain/go-allsportschain/rpc"
	"github.com/allsportschain/go-allsportschain/swarm/api"
	httpapi "github.com/allsportschain/go-allsportschain/swarm/api/http"
	"github.com/allsportschain/go-allsportschain/swarm/fuse"
	"github.com/allsportschain/go-allsportschain/swarm/log"
	"github.com/allsportschain/go-allsportschain/swarm/network"
	"github.com/allsportschain/go-allsportschain/swarm/network/stream"
	"github.com/allsportschain/go-allsportschain/swarm/pss"
	"github.com/allsportschain/go-allsportschain/swarm/state"
	"github.com/allsportschain/go-allsportschain/swarm/storage"
	"github.com/allsportschain/go-allsportschain/swarm/storage/mock"
	"github.com/allsportschain/go-allsportschain/swarm/storage/mru"
	"github.com/allsportschain/go-allsportschain/swarm/tracing"
)
...
func NewSwarm(config *api.Config, mockStore *mock.NodeStore) (self *Swarm, err error) {
	...
	if config.SwapAPI != "" && config.SwapEnabled {
		...
		backend, err = socclient.Dial(config.SwapAPI)
		if err != nil {
...
func newEnsClient(endpoint string, addr common.Address, config *api.Config, privkey *ecdsa.PrivateKey) (*ensClient, error) {
	...
	dns, err := ens.NewENS(transactOpts, ensRoot, socClient)
	if err != nil {
		return nil, err
	}
...
func detectEnsAddr(client *rpc.Client) (common.Address, error) {
	...
	block, err := socclient.NewClient(client).BlockByNumber(ctx, big.NewInt(0))
	if err != nil {
		return common.Address{}, err
	}
