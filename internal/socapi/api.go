...
// NewPublicAllsportschainAPI creates a new Ethereum protocol API.
func NewPublicAllsportschainAPI(b Backend) *PublicAllsportschainAPI {
	return &PublicAllsportschainAPI{b}
}

// GasPrice returns a suggestion for a gas price.
func (s *PublicAllsportschainAPI) GasPrice(ctx context.Context) (*hexutil.Big, error) {
	price, err := s.b.SuggestPrice(ctx)
	return (*hexutil.Big)(price), err
}

// ProtocolVersion returns the current Ethereum protocol version this node supports
func (s *PublicAllsportschainAPI) ProtocolVersion() hexutil.Uint {
...
func (s *PublicAllsportschainAPI) Syncing() (interface{}, error) {
...
//
// https://github.com/allsportschain/go-allsportschain/wiki/Management-APIs#personal_sign
...
//
// https://github.com/allsportschain/go-allsportschain/wiki/Management-APIs#personal_ecRecover
...
func (s *PublicBlockChainAPI) GetCalledCount(ctx context.Context, address common.Address, blockNr rpc.BlockNumber) (*hexutil.Big, error) {
	state, _, err := s.b.StateAndHeaderByNumber(ctx, blockNr)
	if state == nil || err != nil {
		return nil, err
	}
	return (*hexutil.Big)(state.GetCalledCount(address)), state.Error()
}
