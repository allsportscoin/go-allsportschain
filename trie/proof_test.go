...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *socdb.MemDatabase {
	var provers []func(key []byte) *socdb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *socdb.MemDatabase {
		proof := socdb.NewMemDatabase()
