...
type Database struct {
	diskdb socdb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb socdb.Database) *Database {
	return &Database{
		diskdb:    diskdb,
...
func (db *Database) commit(hash common.Hash, batch socdb.Batch) error {
