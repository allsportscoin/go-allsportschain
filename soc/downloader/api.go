...
// Syncing provides information when this nodes starts synchronising with the Allsportschain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  allsportschain.SyncProgress `json:"status"`
}
